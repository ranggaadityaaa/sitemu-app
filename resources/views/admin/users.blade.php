<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight pl-2">
            <i class="fa-solid fa-users mr-1 text-purple-500"></i> Kelola User
        </h2>
    </x-slot>
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-4 py-3">
                            ...
                            @else
                                ...
                                {{-- Modal Ban --}}
                                <div id="banModal{{ $user->id }}" class="hidden fixed inset-0 bg-black/50 flex items-center justify-center z-50">
                                    <div class="bg-white rounded-xl p-6 w-96">
                                        <h3 class="font-bold text-lg mb-3">Ban {{ $user->name }}?</h3>
                                        <form action="{{ route('admin.users.ban', $user) }}" method="POST">
                                            ...
                                            <div class="flex gap-2">
                                                <button type="submit" class="flex-1 bg-red-500 text-white py-2 rounded-lg text-sm">
                                                    Ban User
                                                </button>
                                                <button type="button"
